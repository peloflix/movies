...
BOT_TOKEN = environ.get('BOT_TOKEN', '7701393549:AAGkvpV3T0c_m3UfvFwvbMvSfVbbRvyqHoA')
#---------------------------------------------------------------
#---------------------------------------------------------------
...
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/movieschnels')
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002412551067').split()]
#---------------------------------------------------------------
#---------------------------------------------------------------
DATABASE_URI = environ.get('DATABASE_URI', "Mongo db:- mongodb+srv://peloflix:peloflix@cluster0.m79gr.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
